...
builder.Services.AddDbContext<WarehouseDBAuthUtils>(options =>
options.UseSqlServer(builder.Configuration.GetConnectionString("WarehouseAuthConnString")));



builder.Services.AddScoped<ICategoryRepository, SQLCategoryRepository>();
builder.Services.AddScoped<IProductRepository, SQLProductRepositorycs>();
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("OnlineShop")
    .AddEntityFrameworkStores<WarehouseDBAuthUtils>()
